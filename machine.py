...
class Machine:
    ...
    def setup(self, settings: LaserSettings, field_size_x: float, field_size_y: float):
        ...
        self.commander.cmd_raw_set_standby(
            settings.standby_param_1, settings.standby_param_2, 0, 0
        )
        ...
        self.commander.cmd_raw_set_fpk_param_2(
            settings.fpk2_p1, settings.fpk2_p2, settings.fpk2_p3, settings.fpk2_p4
        )
        self.commander.cmd_raw_set_fly_res(
            settings.fly_res_p1,
            settings.fly_res_p2,
            settings.fly_res_p3,
            settings.fly_res_p4,
    ...
    def _send_correction_table(self, table=None):
        ...
        if table is None:
            ...
            for n in range(65**2):
                self.commander.cmd_raw_write_correction_line(
